defmodule BitsharesReporting.Report do
  require Elixlsx

  alias BitsharesReporting.ElasticsearchClient
  alias BitsharesReporting.Report.Columns.{BaseAmount, BaseAssetName, BlockNumber, BlockTime, Description, FeeAmount}
  alias BitsharesReporting.Report.Columns.{FeeAssetName, OperationName, QuoteAmount, QuoteAssetName, TransactionID}
  ...
  defp data_rows_without_balances(account_name) do
    transactions = ElasticsearchClient.invoke("account_history", account_name)
